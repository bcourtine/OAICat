...
public class CrosswalkItem {
    ...
    /** Class logger. */
    private static final Logger LOGGER = LoggerFactory.getLogger(CrosswalkItem.class);
    ...
    public CrosswalkItem(String nativeRecordSchema, String metadataPrefix, String schema, String metadataNamespace,
    ...
    public CrosswalkItem(String nativeRecordSchema, String metadataPrefix, String schema, String metadataNamespace,
            Class crosswalkClass, String xsltName) throws OAIInternalServerError {
    ...
    public CrosswalkItem(String nativeRecordSchema, String metadataPrefix, String schema, String metadataNamespace, Class crosswalkClass)
            throws OAIInternalServerError {
    ...
    private Crosswalk getCrosswalk(Class crosswalkClass)
        ...
        return (Crosswalk) constructor.newInstance(this);
    }
